...
class _ChecklistScreenState extends State<ChecklistScreen> {
  ...
  Future<void> submit() async {
    await api.post('/api/checklists/submit', { 'date': DateTime.now().toIso8601String().substring(0,10), 'userId': '00000000-0000-0000-0000-000000000000', 'category': 'safety', 'items': items });
